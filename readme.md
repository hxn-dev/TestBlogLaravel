...
Réécriture du test en laravel


### Installation
1. Télécharger ou cloner le repository
2. Ouvrir l'invite de commande depuis le dossier
3. Lancer "composer install"
4. Lancer "php artisan serve" et c'est parti!
 
Pas besoin de base donnée, le driver utilisé est **sqlite**, tout est donc stocké dans un fichier
